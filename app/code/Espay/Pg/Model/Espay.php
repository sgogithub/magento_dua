...
use Espay\Pg\Model\Config\Source\Order\Status\Paymentreview;
use Magento\Sales\Model\Order;

class Espay extends \Magento\Payment\Model\Method\AbstractMethod
{
    const ESPAY_PAYMENT_CODE = 'espay';
    /**
     * @var bool
     */
     ...
     * @var string
     */
    protected $_formBlockType = 'Espay\Pg\Block\Form\Espay';
